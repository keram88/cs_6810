...
space efficient than L2. We can see this in the ratio of the areas of
the cache sizes with L2 being about 26 times larger than L1, but L2 is
storing 32 times as much information. From
$\frac{28}{32}\approx75\%$ we can see directly the inefficiency of
the L1 cache in terms of its area; the L2 cache is using .75 of the area used by L1 per bit.
